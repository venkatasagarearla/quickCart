...
<body>
	...
	<div class="container mt-5">
		<h1 class="mb-4">Update the product</h1>

		<form method="post">
			<div class="mb-3">
				<label for="productName" class="form-label">Product Name</label> <input
					type="text" class="form-control" id="productName" name="title" value="${product.title}"
					required>
			</div>
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="productDescription"
					name="description" rows="4" required>${product.description}</textarea>
			</div>
